...
%Tweaked for ABR's by Luz Andrino -- April 22 2024 
%trying to loop through all files in a folder to average across then plot
clear;
clc;

%This script is where I use the lowpass function and comment out
%butterworth - Luz
...
%% apply filter 
% 
lowpass(ABR_GA_sum(:,j),3000,fs);% already filtered in line 48 but see what this does
